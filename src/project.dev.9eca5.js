window.__require = function e(t, n, r) {
    ...
    var GameMgr = function() {
      ...
      GameMgr.prototype.backStep = function() {
        ...
        var _loop_1 = function() {
          ...
          poker.setPosState(Poker_1.POS_STATE.NORMAL);
  ...
  Pokers: [ function(require, module, exports) {
    ...
    exports.COLOR_GRAY = cc.color(155, 155, 155);
    exports.OFFSET_Y = -70;
    exports.OFFSET_X = 0;
    exports.OFFSET_SCALE = 30;
    cc._RF.pop();
  }, {} ],
  Poker: [ function(require, module, exports) {
    ...
    var Poker = function(_super) {
      ...
      Poker.prototype.checkPos = function() {
        ...
        pos.y - this.node.height + offset <= Game_1.Game.pokerClip.y ? poker.emitNodeEventToForward("pos-scale") : poker.emitNodeEventToForward("pos-normal");
      };
      ...
      Poker.prototype.onAddChild = function(child) {
        ...
        poker.setNormal();
        this.posState == POS_STATE.SCALE && child.emit("pos-scale", this.key);
      ...
      Poker.prototype.updateState = function() {
        if (this.next) {
          if (Poker_1.checkBeNext(this, this.next) && this.next.isNormal()) this.setNormal(); else {
            this.frontCard.node.color = Pokers_1.COLOR_GRAY;
            this.canMove = false;
          }
